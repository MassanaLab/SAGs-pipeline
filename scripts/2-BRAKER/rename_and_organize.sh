...
BASE="lustre/braker_${W}"
STORE="store/braker_${W}"
LIST="data/clean/names_${W}.txt"

# If your file is literally named names_full_remake_145.txt, use:
# LIST="data/clean/names_full_remake_145.txt"
...
while IFS= read -r sample; do
  ...
  declare -A from_to=(
    ...
    ["braker.gff3"]="${sample}_braker.gff3"
